...
const DetailsPage = () => {
	/* hier wird mit params der Name, die von der pokemonlist vom Nutzer ausgewählt wurde übernommen und an die Detailspage übergeben. Der Zweite fetch zeigt in der Detailspage das vom Nutzer ausgewählte Pokemon*/
